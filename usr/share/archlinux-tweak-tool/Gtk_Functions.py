...
#     if os.path.isfile(fn.gtk3_settings):
#         try:
#             active_combo = ""
#             combo.get_model().clear()
#             coms = []
#             with open(fn.gtk3_settings, "r", encoding="utf-8") as f:
#                 lines = f.readlines()
#                 f.close()
#             pos = int(fn.gtkget_position(lines, "gtk-theme-name"))
...
#                     combo.set_active(i)
#         except:
#             fn.MessageBox("ERROR!!", "An error has occured getting this setting \'gtk-theme-name\'")
...
#                 lines = f.readlines()
#                 f.close()
#             pos = int(fn.gtkget_position(lines, "gtk-icon-theme-name"))
#             output = lines[pos].split("=")
...
#                     combo.set_active(i)
#         except:
#             fn.MessageBox("ERROR!!", "An error has occured getting this setting \'gtk-icon-theme-name\'")
...
#                 lines = f.readlines()
#                 f.close()
#             pos = int(fn.gtkget_position(lines, "gtk-cursor-theme-name"))
#             output = lines[pos].split("=")
...
#                     combo.set_active(i)
#         except:
#             fn.MessageBox("ERROR!!", "An error has occured getting this setting \'gtk-cursor-theme-name\'")


# def get_mono_font(name):
#     if os.path.isfile(fn.xfce_config):
#         try:
#             with open(fn.xfce_config, "r", encoding="utf-8") as f:
#                 lines = f.readlines()
#                 f.close()
...
#                 lines = f.readlines()
#                 f.close()
#             pos = int(fn.gtkget_position(lines, item))
#             output = lines[pos].split("=")
#             active_cursor = output[1].lstrip().rstrip()

#         except:
#             fn.MessageBox("ERROR!!", "An error has occured getting this setting \'get_gtk_settings\'")
...
#     if os.path.isfile(fn.gtk2_settings):
#         if not os.path.isfile(fn.gtk2_settings + ".bak"):
#             fn.shutil.copy(fn.gtk2_settings,fn.gtk2_settings + ".bak")

#         with open(fn.gtk2_settings, 'r', encoding='utf-8') as f:
#             lines = f.readlines()
#             f.close()
#         try:
#             data = fn.check_value(lines, item)
#             if not data:
...
#             else:
#                 pos = int(fn.get_position(lines, item))
#                 lines[pos] = ''.join([item,"=\"",str(value),"\"\n"])


#             with open(fn.gtk2_settings, 'w') as f:
#                 f.writelines(lines)
#                 f.close()
#         except:
#             GLib.idle_add(fn.MessageBox,"ERROR!!", "An error has occured getting this setting \'gtk2_save_settings\'")


# def gtk3_save_settings(value, item):

#     if os.path.isfile(fn.gtk3_settings):
#         if not os.path.isfile(fn.gtk3_settings + ".bak"):
#             fn.shutil.copy(fn.gtk3_settings,fn.gtk3_settings + ".bak")

#         with open(fn.gtk3_settings, 'r', encoding='utf-8') as f:
#             lines = f.readlines()
#             f.close()
#         try:
#             data = fn.gtk_check_value(lines, item)
#             if not data:
#                 print("Lines = " + str(len(lines)))
#                 pos = 4
#                 print("Pos = " + str(pos))
...
#             with open(fn.gtk3_settings, 'w') as f:
#                 f.writelines(lines)
#                 f.close()
#         except:
#             GLib.idle_add(fn.MessageBox,"ERROR!!", "An error has occured getting this setting \'gtk3_save_settings\'")

# # def set_xfce_settings(theme, icon, cursor, cursize, fonts, monofonts):

# def set_xfce_settings(theme, icon, cursor, cursize):
#     if os.path.isfile(fn.xfce_config):
#         if not os.path.isfile(fn.xfce_config + ".bak"):
#             fn.shutil.copy(fn.xfce_config, fn.xfce_config + ".bak")
#         try:
#             with open(fn.xfce_config, "r", encoding="utf-8") as f:
#                 lines = f.readlines()
#                 f.close()
...
#             with open(fn.xfce_config, "w") as f:
#                 f.writelines(lines)
#                 f.close()
#             # tree = et.parse(fn.xfce_config)
...
#             # tree.write(fn.xfce_config, encoding="utf-8", xml_declaration=True)
#         except:
#             GLib.idle_add(fn.MessageBox,"ERROR!!", "An error has occured setting this setting \'set_xfce_settings\'")
...
#     fn.subprocess.call(["xsetroot -xcf /usr/share/icons/" + cursorCombo + "/cursors/left_ptr " + str(cursor_size)], shell=True)
