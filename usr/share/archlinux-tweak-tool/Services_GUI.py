...
def GUI(self, Gtk, vboxStack14, Functions):
    ...
    #hbox10.pack_start(self.samba_share_browseable, False, False, 10)
    ...
    #hbox11.pack_start(self.samba_share_guest, False, False, 10)
    ...
    #hbox12.pack_start(self.samba_share_public, False, False, 10)
    ...
    #hbox13.pack_start(self.samba_share_writable, False, False, 10)
