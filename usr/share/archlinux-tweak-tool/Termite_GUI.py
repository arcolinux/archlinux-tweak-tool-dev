...
def GUI(self, Gtk, vboxStack7, termite, GdkPixbuf, base_dir):
   ...
   label26 = Gtk.Label()
   label26.set_markup("Choose your <b>Alcritty</b> theme")
   ...
   btn_reset_alacritty = Gtk.Button(label="Reset alacritty")
   ...
   #btn_choose_xfce4_theme = Gtk.Button(label="Open xfce4-terminal")
   #btn_choose_xfce4_theme.connect("clicked", self.on_clicked_launch_xfce4_themes)
