...
We will backup your files")
        ...
        hbox15.pack_start(self.sddm_cursor_themes, True, True, 10)
    ...
    if Functions.check_package_installed("lightdm"):
        ...
        self.gtk_theme_names = Gtk.ComboBoxText()
        lightdm.pop_gtk_theme_names_lightdm(self, self.gtk_theme_names)
        hbox30.pack_start(hbox30_lbl, False, False, 10)
        hbox30.pack_end(self.gtk_theme_names, False, False, 10)
        ...
        self.gtk_icon_names = Gtk.ComboBoxText()
        lightdm.pop_gtk_icon_names_lightdm(self, self.gtk_icon_names)
        hbox33.pack_start(hbox33_lbl, False, False, 10)
        hbox33.pack_end(self.gtk_icon_names, False, False, 10)
