...
def GUI(self, Gtk, GdkPixbuf, vboxStack10, sddm, Functions):
    ...
    label_sddm_enable = Gtk.Label(xalign=0)
    label_sddm_enable.set_text("Enable Sddm")    
    ...
    hbox14.pack_end(label_sddm_enable, False, False, 10)
    
    hbox13.pack_start(reset_sddm_original, False, False, 10)
    hbox13.pack_end(enable_sddm, False, False, 10)    
